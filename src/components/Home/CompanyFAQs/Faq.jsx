...
function Faq() {
  return (
    <>
      <div className="relative w-full px-4 pt-10 pb-8 mt-8 bg-white shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-3xl sm:rounded-lg sm:px-10">
        <div className="px-5 mx-auto">
          <div className="flex flex-col items-center">
            <h2 className="mt-5 text-3xl font-bold tracking-tight text-center md:text-5xl">
              FAQ
            </h2>
          ...
          <div className="grid gap-4 mx-auto mt-8 divide-y divide-neutral-200">
            <div className="py-5">
              <details className="group">
                ...
                <p className="mt-3 group-open:animate-fadeIn text-neutral-600">
